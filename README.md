...
Los itinerarios preparados incluyen [`crear-webs-con-ia`](./cursos/crear-webs-con-ia/README.md), asociado al curso **Crea webs profesionales con IA desde cero**; [`higiene-repositorio-agentes`](./cursos/codex-programadores/laboratorios/higiene-repositorio-agentes/), donde se practica cómo reducir código redundante sin alterar el comportamiento; [`ollama-piloto-seguro`](./cursos/ia-pymes/laboratorios/ollama-piloto-seguro/), que mide una prueba local con datos ficticios y bloquea destinos remotos; [`de-chat-a-agente`](./cursos/agentes-automatizacion/laboratorios/de-chat-a-agente/), una progresión ejecutable desde una llamada simple hasta un loop con tool, evidencia y parada; [`guardas-coste-y-loops`](./cursos/agentes-automatizacion/laboratorios/guardas-coste-y-loops/), que detiene repeticiones, cuotas, tiempos y presupuestos antes de ejecutar una acción; [`auditoria-chats-compartidos`](./cursos/ia-desde-cero/laboratorios/auditoria-chats-compartidos/), que convierte la revisión de enlaces públicos en una práctica sin red y sin datos reales; [`verificar-excel-con-ia`](./cursos/ia-pymes/laboratorios/verificar-excel-con-ia/), donde una fórmula plausible se contrasta con casos conocidos y una conciliación independiente; [`minimizar-datos-antes-ia`](./cursos/ia-pymes/laboratorios/minimizar-datos-antes-ia/), que retira y generaliza información antes de preparar una entrada para un modelo; [`convertir-extracto-csv`](./cursos/ia-pymes/laboratorios/convertir-extracto-csv/), que bloquea filas inventadas, signos erróneos, categorías fuera de catálogo y totales sin conciliar; [`mcp-oficina-solo-lectura`](./cursos/ia-pymes/laboratorios/mcp-oficina-solo-lectura/), que construye y prueba tres herramientas MCP locales sin escritura, secretos ni datos personales; [`evaluar-rag-citas-abstencion`](./cursos/rag-seguro/laboratorios/evaluar-rag-citas-abstencion/), que mide por separado recuperación, citas, abstención, cuarentena y aislamiento entre clientes; e [`inyeccion-indirecta-documentos`](./cursos/rag-seguro/laboratorios/inyeccion-indirecta-documentos/), que impide que PDFs, webs, hojas o tools no confiables autoricen efectos. El catálogo crecerá a medida que Aulafy publique y revise ejemplos de otros cursos.
